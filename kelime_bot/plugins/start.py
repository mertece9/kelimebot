...
keyboard = InlineKeyboardMarkup([
    [
        InlineKeyboardButton("➕ Grubuna Ekle", url=f"http://t.me/VipOyunBot?startgroup=new")
    ],
    [
        InlineKeyboardButton("🇹🇷 Sahibim", url="t.me/tMertTt"),
        InlineKeyboardButton("💬 Support", url="t.me/ProTubeSupport"),
    ]
])


START = """
**🔮 Merhaba, Karışık Kelimeleri bulma oyununa hoş geldin..**
...
async def start(bot, message):
  await message.reply_photo("https://images.aposto.com/2021/0/2021-01-20T12:49:23.463Z.png",caption=START,reply_markup=keyboard)

@Client.on_message(filters.command("help"))
async def help(bot, message):
  await message.reply_photo("https://images.aposto.com/2021/0/2021-01-20T12:49:23.463Z.png",caption=HELP) 
